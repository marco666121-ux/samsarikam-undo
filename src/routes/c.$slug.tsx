        ...
        <div className="glass-strong -mt-8 mx-3 rounded-2xl p-4 md:mx-6">
          <div className="flex items-end justify-between gap-3">
            <div className="flex items-end gap-3">
              ...
              <div className="text-xs text-muted-foreground">{c.malayalam} · {((Number(c.members) || 0) / 1000).toFixed(1)}k members · <span className="text-primary">{c.online ?? 0} online</span></div>
              </div>
            </div>
